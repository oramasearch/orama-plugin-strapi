              ...
              <Tr key={field}>
                ...
                >
                  ...
                  {contentTypeSchema[field] === 'collection' && (
                    <>
                      {/*
                      DOES NOT WORK YET - AWAITING FOR STRAPI DESIGN SYSTEM FIX
                      ...
                      <a
                        href="https://docs.orama.com/cloud/data-sources/native-integrations/strapi"
                        target="_blank"
                        title="This attribute needs work through a documentsTransformer"
                      >
                        <WarningIcon size={16} fill="#ddaa00" style={{ margin: '5px 0 0 5px' }} />
                      </a>
                    </>
